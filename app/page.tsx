      ...
      >
        <Suspense fallback={<Loading />}>
          ...
          <div className="mx-5 w-11/12 text-sm/9 tracking-wide">
            ...
            <p>
              هر کابین دارای چشم‌اندازی زیبا به طبیعت اطراف است که آرامش و لذت
              را به شما هدیه می‌دهد.
            </p>
            <p>
              امکاناتی نظیر اینترنت پرسرعت، سیستم گرمایش و سرمایش، و آشپزخانه
              مجهز در این کابین‌ها فراهم شده است.
            </p>
            <p>
            ...
            <p>
              موقعیت مکانی این کابین‌ها به گونه‌ای است که دسترسی آسان به
              جاذبه‌های گردشگری منطقه را فراهم می‌کند.
            </p>
            <p>
              اقامت در این کابین‌ها تجربه‌ای فراموش‌نشدنی از طبیعت و آرامش را
